    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Xydlan - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6281400346604">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Xydlan Lux</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Xydlan Lux" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Xydlan Lux`,
        html: inboxGmail,
      };
